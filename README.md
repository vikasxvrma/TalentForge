...
> ⚠️ **Note:** The backend API is currently down for scheduled maintenance. The frontend may not be fully functional until service is restored.
...
> ⚠️ Currently under maintenance — temporarily unavailable.
